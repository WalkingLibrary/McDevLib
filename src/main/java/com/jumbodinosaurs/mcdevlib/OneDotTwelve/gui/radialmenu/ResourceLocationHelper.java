...
public class ResourceLocationHelper
{
    ...
    public static ResourceLocation spinArrowCounterClockWiseIcon = new ResourceLocation("icons",
                                                                                        "spinarrowcounterclockwise.png");
    ...
    public static ResourceLocation retentionIcon = new ResourceLocation("icons", "retention.png");
